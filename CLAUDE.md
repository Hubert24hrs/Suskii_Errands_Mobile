...
| Kimi | M1 + M2 committed (`e473c9b`). M3 uncommitted, packages only (no screens yet). Follow-up 2026-09-17: all findings through M3.10 fixed and verified; package suites green (94 tests). Open: M3.6 (contract), M3.12–M3.13 low. Screens not started |
