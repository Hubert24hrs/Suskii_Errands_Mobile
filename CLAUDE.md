...
| Next Claude work | Phases 2–4 are built and Phase 6's database half with them; Phase 5 (money) is blocked on client answers, not on code: OD-06 (commission rate), OD-08 (gateway fee on refunds), OD-12 (funds holding model) and OD-19. Deploy pipelines exist but stay switched off until the client's GCP projects, Supabase org and GitHub environments exist (RB-14 checklist). Buildable meanwhile: Phase 8's admin backend, and Phase 6's Edge Functions once LiveKit and a telephony provider are contracted. Rolling review of Kimi's milestones; Stage B at M8.5. Launch base case: week of 7 Jun 2027 |
